    ...
    return [
        {
            ...
            "ingredients": ["branzino", "lemon", "olive oil", "capers", "thyme"],
            "allergens": ["fish"], "allergen_family": ["fish"],
            "flavor_profile": ["bright_acidic", "herbaceous", "briny_oceanic"],
            "price": 38.0,
        },
        {
            ...
            "flavor_profile": ["rich_savory"],
            "price": 62.0,
        },
        {
            "id": "menu_003", "name": "Black Truffle Risotto", "category": "entree",
            "ingredients": ["arborio rice", "black truffle", "parmesan", "shallot", "butter", "white wine"],
            "allergens": ["dairy", "allium", "sulfite"], "allergen_family": ["dairy", "allium", "sulfite"],
            "flavor_profile": ["rich_savory", "sweet_aromatic"],
            "price": 44.0,
        },
        {
            "id": "menu_004", "name": "Caesar Salad", "category": "appetizer",
            "ingredients": ["romaine", "parmesan", "anchovy", "garlic", "egg yolk", "lemon", "breadcrumb"],
            "allergens": ["dairy", "fish", "egg", "allium", "gluten"],
            "allergen_family": ["dairy", "fish", "egg", "allium", "gluten"],
            "flavor_profile": ["bright_acidic", "rich_savory"],
            "price": 18.0,
        },
        {
            "id": "menu_005", "name": "Lobster Bisque", "category": "appetizer",
            "ingredients": ["lobster", "cream", "shallot", "brandy", "tomato paste", "thyme"],
            "allergens": ["shellfish", "dairy", "allium"],
            "allergen_family": ["shellfish", "dairy", "allium"],
            "flavor_profile": ["rich_savory", "creamy_mild", "briny_oceanic"],
            "price": 22.0,
        },
        {
            "id": "menu_006", "name": "Roasted Beet Salad", "category": "appetizer",
            "ingredients": ["beet", "goat cheese", "walnut", "arugula", "balsamic"],
            "allergens": ["dairy", "tree_nut"],
            "allergen_family": ["dairy", "tree_nut"],
            "flavor_profile": ["bright_acidic", "sweet_aromatic"],
            "price": 16.0,
        },
        {
            "id": "menu_007", "name": "Pan-Seared Scallops", "category": "entree",
            "ingredients": ["scallop", "cauliflower puree", "butter", "caper", "lemon"],
            "allergens": ["shellfish", "dairy"],
            "allergen_family": ["shellfish", "dairy"],
            "flavor_profile": ["creamy_mild", "briny_oceanic"],
            "price": 42.0,
        },
    ]
